...
public class SelectConditionPlugin extends PluginAdapter {
    ...
    private void addSelectConditionMethod(Interface interfaze, IntrospectedTable introspectedTable) {
        ...
        // 3.设置方法名
        ibsmethod.setName("selectCondition");
    ...
    public void addSelectConditionXml(Document document, IntrospectedTable introspectedTable) {
        ...
        selectElement.addAttribute(new Attribute("id", "selectCondition"));
        ...
        selectElement.addElement(
                new TextElement("select ${fields} from " + introspectedTable.getAliasedFullyQualifiedTableNameAtRuntime()));
...
//        selectElement.addElement(new TextElement("<if test=\"orderByClause != null\">"));
//        selectElement.addElement(new TextElement("    order by ${orderByClause}"));
//        selectElement.addElement(new TextElement("</if>"));
//
//        selectElement.addElement(new TextElement(" <if test=\"page != null\">"));
//        selectElement.addElement(new TextElement("        limit #{page.begin} , #{page.size}"));
//        selectElement.addElement(new TextElement("</if>"));
